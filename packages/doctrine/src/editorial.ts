...
const SECTION_WORD_BUDGETS: Readonly<Record<ReportSectionKey, number>> = {
  actions: 500,
  birthday_psychic_comparison: 500,
  core_overview: 500,
  cover_reading_guide: 300,
  current_name_comparison: 500,
  growth_edges: 480,
  input_methods: 400,
  life_path: 180,
  lo_shu_augmented_comparison: 400,
  lo_shu_raw_grid: 400,
  methodology_appendix: 600,
  name_change_comparison: 500,
  personal_months: 600,
  personal_year: 400,
  relationships: 450,
  repeated_strengths: 500,
  western_name_layers: 500,
  work_money: 450,
};
